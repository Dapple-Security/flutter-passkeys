...
struct RegisterResponse {
  ...
  var clientExtensionResults: String? = nil
  ...
  static func fromList(_ list: [Any?]) -> RegisterResponse? {
    ...
    let clientExtensionResults: String? = nilOrValue(list[5])
...
struct AuthenticateResponse {
  ...
  static func fromList(_ list: [Any?]) -> AuthenticateResponse? {
    ...
    let clientExtensionResults: String? = nilOrValue(list[6])
...
protocol PasskeysApi {
  ...
  func register(challenge: String, relyingParty: RelyingParty, user: User, excludeCredentials: [CredentialType], pubKeyCredValues: [Int64], canBePlatformAuthenticator: Bool, canBeSecurityKey: Bool, residentKeyPreference: String?, attestationPreference: String?, extensions: String?, completion: @escaping (Result<RegisterResponse, Error>) -> Void)
  func authenticate(relyingPartyId: String, challenge: String, conditionalUI: Bool, allowedCredentials: [CredentialType], preferImmediatelyAvailableCredentials: Bool, extensions: String?, completion: @escaping (Result<AuthenticateResponse, Error>) -> Void)
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: PasskeysApi?) {
    ...
    if let api = api {
      registerChannel.setMessageHandler { message, reply in
        ...
        let extensionsArg: String? = nilOrValue(args[9])
    ...
    if let api = api {
      authenticateChannel.setMessageHandler { message, reply in
        ...
        let extensionsArg: String? = nilOrValue(args[5])
        api.authenticate(relyingPartyId: relyingPartyIdArg, challenge: challengeArg, conditionalUI: conditionalUIArg, allowedCredentials: allowedCredentialsArg, preferImmediatelyAvailableCredentials: preferImmediatelyAvailableCredentialsArg, extensions: extensionsArg) { result in
          switch result {
            case .success(let res):
              reply(wrapResult(res))
            case .failure(let error):
